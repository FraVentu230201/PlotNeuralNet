...
\definecolor{ConvColor}{HTML}{F7D9B4}\definecolor{ConvReluColor}{HTML}{CF5712}\definecolor{PoolColor}{HTML}{FFF1DC}\definecolor{SoftmaxColor}{HTML}{9E86E8}\definecolor{SumColor}{HTML}{E27C00}\def\ConvColor{ConvColor}\def\ConvReluColor{ConvReluColor}\def\PoolColor{PoolColor}\def\SoftmaxColor{SoftmaxColor}\def\SumColor{SumColor}\def\DcnvColor{rgb:blue,5;green,2.5;white,5}
